  ...
  return (
    <div className=" py-10 container px-2 mx-auto">
      <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 gap-y-10">
        {posts?.map((post: { title: string, description: string, slug: string , id : string , createdAt : string }) => (
          <Link href={'/blog/1'} key={post?.id} id='card'>
            <div className=' w-full flex  items-center'>
              ...
              <p className=' w-4 text-center whitespace-nowrap m-auto rotate-[270deg] text-sm text-gray-400'>{post?.createdAt.slice(0, 15)}</p>
            </div>
